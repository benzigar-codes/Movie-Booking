...
<body class="bg-primary">
    <div class="container col-lg-5 col-sm-12 col-md-5 mt-4 bg-primary">
        <form action="index.php" method="post">
            <h1 class="text-white m-4 text-center">Movie Booking</h1>
            <div class="card m-3 p-3 shadow">
                ...
                <a class="text-center mt-3" href="createaccount.php">New user ?? :)</a>
            </div>
        </form>
    </div>
</body>
